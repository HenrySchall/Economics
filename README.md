...
> Os dados econômicos apresentam-se em uma variedade de tipos. Para quantificar esses dados, utiliza-se da econométria (teoria econômica + matemática), embora os métodos econométricos possam ser aplicados com pouca ou nenhuma modificação para muitos tipos de dados, sempre haverá casos especiais que não devem ser ignorados. a seguir as estruturas de dados mais importantes encontradas nos trabalhos aplicado
...
Exemplos de campos da Economia:
